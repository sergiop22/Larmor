...
<!-- multistep form -->
<?php $__currentLoopData = $secuencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $secuencia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<form id="msform" action="/validacion" method="POST">
  ...
  <!-- fieldsets -->
  <fieldset>
    <h2 class="fs-title"><?php echo e($caso->dx); ?></h2>
    <h3 class="fs-subtitle">Protocolo: <?php echo e($caso->protocolo); ?></h3>
    <h3 class="fs-title2">Secuencia: <?php echo e($secuencia->nombre); ?></h3>
  ...
  <fieldset>
    ...
    <h3 class="fs-subtitle">Protocolo: <?php echo e($caso->protocolo); ?></h3>
    <h3 class="fs-title2">Secuencia: <?php echo e($secuencia->nombre); ?></h3>
    <h3 class="fs-subtitle">Grosor de corte: <?php echo e($secuencia->grosor_corte); ?> </h3>
    <h3 class="fs-subtitle">Campo de visión: <?php echo e($secuencia->campo_vision); ?> </h3>
    <h3 class="fs-subtitle">Matriz: <?php echo e($secuencia->matriz); ?></h3>
    <h3 class="fs-subtitle">Adquisiciones: <?php echo e($secuencia->adquisiciones); ?> </h3>
    <h3 class="fs-subtitle">Dirección de Fase: <?php echo e($secuencia->direccion_fase); ?></h3>
    <h3 class="fs-subtitle">---------------------------------------------------</h3>
    <input type="button" name="previous" class="previous action-button" value="Anterior" />
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    <input name="id_final" value="<?php echo e($secuencia->id); ?> "/>
...
<?php /**PATH C:\laragon\www\Proyecto\resources\views/Practicas/respuesta.blade.php ENDPATH**/ ?>