...
<body style="background-image: url(/img/fondo1.jpg); background-size: cover;">
  ...
  <table width="80%" cellspacing="5" cellpadding="5">
      ...
      <tr>
        <td>
          <a href="<?php echo e(route('libro.descarga', 01)); ?>" >
            <i class="fa fa-download"></i> Descargar 
          </a>
        </td>
        <td>
          <a href="<?php echo e(route('libro.descarga', 02)); ?>" >
            <i class="fa fa-download"></i> Descargar 
          </a>
        </td>
        <td>
          <a href="<?php echo e(route('libro.descarga', 03)); ?>" >
            <i class="fa fa-download"></i>  Descargar 
          </a>
        </td>
      </tr>
      ...
      <tr>
        <td>
          <a href="<?php echo e(route('libro.descarga', 4)); ?>" >
            <i class="fa fa-download"></i> Descargar 
          </a>
        </td>
        <td>
          <a href="<?php echo e(route('libro.descarga', 5)); ?>" >
            <i class="fa fa-download"></i>  Descargar 
          </a>
        </td>
        <td>
          <a href="<?php echo e(route('libro.descarga', 6)); ?>" >
            <i class="fa fa-download"></i> Descargar 
          </a>
        </td>
      </tr>
      ...
      <tr>
        <td>
          <a href="<?php echo e(route('libro.descarga', 7)); ?>" >
            <i class="fa fa-download"></i> Descargar 
          </a>
        </td>
        <td>
          <a href="<?php echo e(route('libro.descarga', 8)); ?>" >
            <i class="fa fa-download"></i> Descargar 
          </a>
        </td>
        <td>
          <a href="<?php echo e(route('libro.descarga', 9)); ?>" >
            <i class="fa fa-download"></i> Descargar 
          </a>
        </td>
      </tr>
      ...
      <tr>
        <td>
          <a href="<?php echo e(route('libro.descarga', 10)); ?>" >
            <i class="fa fa-download"></i> Descargar 
          </a>
        </td>
      </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Proyecto\resources\views/Investigaciones/librosInvestigacion.blade.php ENDPATH**/ ?>