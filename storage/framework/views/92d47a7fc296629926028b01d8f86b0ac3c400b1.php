...
<html lang="en">
  ...
  <head>
    ...
    <title>Encuestas y Opiniones</title>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <h2 class="section-heading text-white">Encuestas y Opiniones</h2>
                <p class="text-faded mb-4"></p>
                <br>
                <table class='table text-white'>
                  <a class="btn btn-info btn-xl js-scroll-trigger text-dark" href="<?php echo e(route('encuesta.create')); ?>">Genera tu encuesta aquí</a>
                </table>
                <br>
            </div>
            </div>
...
</html><?php /**PATH C:\laragon\www\Proyecto\resources\views/Encuestas/encuestas.blade.php ENDPATH**/ ?>