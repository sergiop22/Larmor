...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger text-dark" style="font-family: candara;" href="{{ url('/') }}">Inicio</a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <h2 class="section-heading" style="color: #00406b;" >{{ Auth::user()->user_name}}</h2>
                <p class="text-faded mb-4"></p>
                <div class="col-md-20 col-md-offset-1">
                  <img src="/img/avatars/{{ Auth::user()->avatar }}" style="width: 150px; height: 150px; border-radius: 50%; margin-left: 5px; margin-bottom: 20px; margin-top: -15px">
