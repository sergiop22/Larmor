            ...
            <li class="nav-item">
              <ul class="navbar-nav ml-auto">
                <!-- Authentication Links -->
                  @guest
                      <li class="nav-item" >
                          <a class="nav-link text-dark" style="color: #0a0a0a;" href="{{ route('login') }}">{{ __('Ingresar') }}</a>
                      </li>
                      <li class="nav-item" >
                          <a class="nav-link text-dark" style="color: #0a0a0a;" href="{{ route('register') }}">{{ __('Registrarse') }}</a>
                      </li>
                  @else
      ...
      <div class="container my-auto">
        <div class="row">
          ...
          <div class="col-lg-8 mx-auto">
            ...
            <a class="btn btn-info btn-xl js-scroll-trigger text-dark" style="font-family: candara; font-size: 17px;" href="{{ url('/practicas') }}">Practica tu conocimiento</a>
          </div>
        </div>
      </div>
    </header>
        ...
        <div class="row mx-md-n4">
          <div class="col-md-4 px-md-5">
            <a  class="btn btn-info btn-block btn-xl text-dark " 
                ...
                href="{{ route('investigacion.index')}}">Investigación</a>
          </div>
          <div class="col-md-4 px-md-5">
            <a  class="btn btn-info btn-block btn-xl text-dark "
                style="font-family: candara; font-size: 17px;" 
                href="{{ url('/foro') }}" >Foro de discusión</a>
          </div>
          <div class="col-md-4 px-md-5">
            <a class="btn btn-info btn-block btn-xl text-dark " 
               style="font-family: candara; font-size: 17px;"
               href="{{ route('secuencia.index') }}">Planeación</a>
          </div>
        </div>
      </div>
    </section>
