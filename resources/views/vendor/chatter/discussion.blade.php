...
<div id="chatter" class="discussion">
	...
	<div id="chatter_header" style="background-color:{{ $discussion->color }}">
		<div class="container">
			...
			<h1>{{ $discussion->title }}</h1><span class="chatter_head_details">Creado en {{ Config::get('chatter.titles.category') }}<a class="chatter_cat" href="/{{ Config::get('chatter.routes.home') }}/{{ Config::get('chatter.routes.category') }}/{{ $discussion->category->slug }}" style="background-color:{{ $discussion->category->color }}">{{ $discussion->category->name }}</a></span>
		</div>
	</div>
	        ...
	        <div class="col-md-12">
				...
				@else
					...
					<div id="login_or_register">
						<p>Porfavor <a href="/{{ Config::get('chatter.routes.home') }}/login">Ingresa</a> o <a href="/{{ Config::get('chatter.routes.home') }}/register">registráte</a> para dejar una respuesta.</p>
					</div>
