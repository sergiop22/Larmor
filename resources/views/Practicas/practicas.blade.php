...
<section class="hero-section">
    <div class="card-grid">
      <a class="card" href="{{ route('caso.index') }}">
      ...
      <a class="card" href="{{ route('secuencia.index') }}">
      ...
      <a class="card" href="{{ route('secuencia.create')}}">
      ...
      <a class="card" href="{{ route('investigacion.index') }}">
